			...
			<div class="auto-style1">
				<table cellSpacing="0" cellPadding="0" onblur="check11()" class="auto-style3">
					...
					<tr>
						...
						<td align="left" class="auto-style4">&nbsp;<asp:textbox id="lblReceiptFromDate" runat="server" Width="80px" BorderStyle="Groove" 
														CssClass="dropdownlist"></asp:textbox><A onclick="if(self.gfPop)gfPop.fPopCalendar(document.all.lblReceiptFromDate);return false;"><IMG class="PopcalTrigger" alt="" src="../../HeaderFooter/DTPicker/calender_icon.jpg"
															align="absMiddle" border="0"></A></td>
						<td>To Date</td>
						<td><asp:textbox id="lblReceiptToDate" runat="server" Width="80px" BorderStyle="Groove" 
														CssClass="dropdownlist"></asp:textbox><A onclick="if(self.gfPop)gfPop.fPopCalendar(document.all.lblReceiptToDate);return false;"><IMG class="PopcalTrigger" alt="" src="../../HeaderFooter/DTPicker/calender_icon.jpg"
															align="absMiddle" border="0"></A></td>
					</tr>
					<tr>
						<td align="center">&nbsp;</td>
